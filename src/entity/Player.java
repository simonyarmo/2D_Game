...
public class Player extends Entity {
    ...
    public void getPlayerImage(){
        try{
            ...
            down1 = ImageIO.read(getClass().getResourceAsStream("/res/player/front1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/res/player/front2.png"));
    ...
    public void update(){
        ...
        if(keyH.upPressed==true|| keyH.downPressed==true ||keyH.leftPressed==true|| keyH.rightPressed==true) {
           ...
           pickUpObject(objIndex);
            ...
            if(currentTime - lastUpdate > updateInterval) { // Check if enough time has passed
                spriteCounter++;
                if (spriteCounter > 12) {
                    if (spriteNum == 1) {
                        spriteNum = 2;
                    ...
                    spriteCounter = 0; // Reset the counter after changing the sprite
                }
